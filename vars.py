...
# API Configuration
API_ID = int(os.environ.get("API_ID", "33130206"))
...
OWNER_ID = int(os.environ.get("OWNER_ID", "1171292822"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "1171292822").split()]  # Default to owner ID
