...
api_url = "https://cp-api-six.vercel.app/"
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/STUDENTZZZZBOT")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/STUDENTZZZZBOT")        ],
    ]
)
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                api_url_call = f"https://studentcpapi.vercel.app/ITsGOLU_OFFICIAL?url={url}"
                keys_string = ""
                mpd = None
                try:
...
async def back_to_start_callback(client, callback_query: CallbackQuery):
    ...
    await callback_query.message.edit_media(
        ...
        reply_markup=InlineKeyboardMarkup([
            [
                InlineKeyboardButton("GOURAV", url="https://t.me/STUDENTZZZZBOT")
            ],
            [
                InlineKeyboardButton("ғᴇᴀᴛᴜʀᴇꜱ 🪔", callback_data="features"),
                InlineKeyboardButton("ᴅᴇᴛᴀɪʟꜱ 🦋", callback_data="details")
